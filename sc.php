...
function  create() {
    ...
    kd.href = 'https://https://hacher-hoc.github.io/anshen.github.io/?id='+myid.value+'&url='+url.value; //修改此处的域名 必须要SSL证书
    kd.style = ''; 
    kd.innerText = 'https://https://hacher-hoc.github.io/anshen.github.io/?id='+myid.value+'&url='+url.value; //修改此处的域名  必须要SSL证书
}
</script>
<div id="bob">
